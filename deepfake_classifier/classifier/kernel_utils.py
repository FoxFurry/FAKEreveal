...
def process_file(file, face_extractor, input_size, frames_per_video, models, strategy=np.mean,
                         apply_compression=False):
    torch.cuda.empty_cache()
    y_pred = predict_on_video(face_extractor=face_extractor, video_path=file,
